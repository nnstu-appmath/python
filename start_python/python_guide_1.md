...
Поподробнее ознакомиться с этими и другими методами для работы с файлами можно в [официальной документации Python.](https://docs.python.org/3/tutorial/inputoutput.html#methods-of-file-objects)
